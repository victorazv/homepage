        ...
        <form action="{{route('paf5')}}" method="get">
            <section id="sec_1" class="how-it-works py-3">
                    ...
                    <div class="row d-sm-flex justify-content-center">
                        ...
                        <div class="col-xs-12 col-md-5 pr-md-0 mt-4 d-flex flex-wrap">
                            <form id="form" class="w-100" action="{{route('form.insert')}}" method="post">
                                ...
                                <div>
                                    <label class="custom-label">Choose your occupation or the one that is closest to
                                        what
                                        you do.*</label>
                                    <br>
                                    <div class="">
                                    ...
                                    <p id="msg_under_occupation" style="display:none">
                                        ...
                                        Your occupation will only be considered if you can provide enough evidence to
                                        prove
                                        your
                                        work experience in that particular occupation. Evidence of employment varies
                                        depending
                                ...
                                <div class="field-box w-100">
                                    <label class="custom-label" for="">What is your work experience in this occupation
                                        in
                                ...
                                <div class="">
                                    ...
                                    <br>
                                    <select id="experience_AU" name="experience_AU"
                ...
                <div class="question w-100 offset-md-2 col-md-8 col-xs-12">
                    <button type="submit" class="float-right mt-3 mr-4">I Understand</button>
                </div>
