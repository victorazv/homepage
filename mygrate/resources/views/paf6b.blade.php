			...
			<div class="row d-sm-flex justify-content-center">
				...
				<div class="col-xs-12 col-md-5 pr-md-0 mt-4 d-flex flex-wrap">
					<form action="">
						...
						<div class="field-box w-100">
							<label for="" class="custom-label">
								Have you undertaken one of these English language proficiency tests in the last 36 months?*
							</label>
							<br>
							<div class="div-select">
						...
						<p>
							If you are applying for Skilled Migration, you will need to prove your English language ability.
							The required level of English depends on the visa subclass you are applying for.
						</p>
						<p>
							The <strong>IELTS</strong> test is the most common way of evidencing English language ability.
							Either the Academic or General Training versions of the test are acceptable to the Department of Immigration,
							but some skills assessing authorities require applicants to sit the Academic version. You will need to obtain a minimum
							score in each band of the IELTS (Reading, Writing, Listening, Speaking) in a single sitting.
						</p>
						<p>
							The <strong>Occupational English Test (OET)</strong> is also accepted as evidence of proficient and superior levels of English.
							The OET is only appropriate for medical and allied health professionals.
						</p>
						<p>
							The <strong>Pearson Academic Test of English (Pearson PTE)</strong> and <strong>TOEFL Internet Based Test (TOEFL iBT)</strong> are now accepted
							for all skilled subclasses. Most state and territory governments also recognise these tests, as do some skills assessment authorities.
						</p>
						<p>
							The <strong>Cambridge Test of English</strong> is also accepted from January 2015.
						</p>
						<p>
							Ok so you didn't do any test yet, but keep in mind that, in order to obtain an Australia Visa,
