...
<main class="mb-3 animated bounceInRight">
	<section id="sec_2a" class="py-3">
		...
		<div class="question w-100 offset-md-2 col-md-8 col-xs-12">
			<button id="no"  class="float-right mt-3 mr-4 button_inactive" onclick="personalizateButton('no', 'yes')">No</button>
			<button id="yes" class="float-right mt-3 mr-4 button_inactive" onclick="personalizateButton('yes', 'no')">Yes</button>
		</div>
		</div>
			<div class="percent_bar col-12 pl-0 d-flex">
				...
				<div class="col-md-2 mt-2 pl-0">
					...
					<a href="/paf3" id="btn_1"><img src="images/img_next.png"></a>
				</div>
			</div>
	</section>
</main>
